    ...
    def _load_data(cls):
        if cls.curve_df is None:
            cls.curve_df = pd.read_csv(
                "/home/pczhang/Nutstore/Udacity/DataStreamingNanoDegree/project1/passed/producer/data/ridership_curve.csv"
            )
        if cls.seed_df is None:
            cls.seed_df = pd.read_csv(
                "/home/pczhang/Nutstore/Udacity/DataStreamingNanoDegree/project1/passed/producer/data/ridership_seed.csv"
            )
