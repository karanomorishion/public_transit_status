...
from consumer.models import Station
...
class Line:
    ...
    def process_message(self, message):
        ...
        # if message.topic() == 'chicago.cta.stations.table': # Set the conditional correctly to the stations Faust Table
        if message.topic() == "chicago.cta.stations.table":
            try:
